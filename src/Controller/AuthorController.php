...
class AuthorController extends AbstractController
{
    ...
    #[route('/list',name:'list_twig')]
    public function List()
    {
        $authors = array(
            array('id' => 1, 'picture' => '/image/Victor_Hugo.jpg','username' => ' Victor
            Hugo', 'email' => 'victor.hugo@gmail.com ', 'nb_books' => 100),
            array('id' => 2, 'picture' => '/image/william_shakespear.jpg','username' => '
            William Shakespeare', 'email' => ' william.shakespeare@gmail.com', 'nb_books' =>
            200 ),
            array('id' => 3, 'picture' => '/image/taha_Hussein.jpg','username' => ' Taha
    ...
    public function AuthorDeatails($id)
       {
        $authors = array(
            ...
            array('id' => 3, 'picture' => '/image/taha_Hussein.jpg','username' => ' Taha
            Hussein', 'email' => 'taha.hussein@gmail.com', 'nb_books' => 300),);
       return $this->render('author/showAuthor.html.twig',['id'=>$id,'authorslist'=>$authors]);
       }
